...
<details>
<summary><strong>Getting Started (CSA-1, CSA-2)</strong></summary>

**Login Process:**
1. Navigate to your Connie URL
2. Enter credentials
3. Land on agent desktop
...
<details>
<summary><strong>Handling Tasks (CSA-3)</strong></summary>

**When a task arrives:**
1. Desktop notification appears
2. Accept within timeout period
3. Customer info displays
4. Previous history shown
...
1. **Keyboard Shortcuts**: Learn them to work faster
2. **Canned Responses**: Customize your favorites
3. **Status Codes**: Use specific break reasons
4. **Notes**: Always document important details
5. **Transfers**: Warm transfer when possible

</TabItem>

<TabItem value="platform" label="🔧 Connie Platform Admin">
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '15px', marginTop: '30px'}}>
  ...
  <div style={{padding: '15px', background: '#f3e5f5', borderRadius: '8px'}}>
    <h4>👥 CBO Manager</h4>
    <ul style={{fontSize: '0.9em', marginBottom: 0}}>
      <li><a href="/end-users/supervisors/overview">Supervisor Guide</a></li>
      <li><a href="/getting-started/feature-library/overview2/supervisor-barge-coach">Barge & Coach</a></li>
      <li><a href="/getting-started/feature-library/overview2/supervisor-capacity">Capacity Management</a></li>
    </ul>
  </div>
  ...
  <div style={{padding: '15px', background: '#e8f5e9', borderRadius: '8px'}}>
    <h4>🎧 CBO Agent</h4>
    <ul style={{fontSize: '0.9em', marginBottom: 0}}>
      <li><a href="/end-users/staff-agents/overview">Agent Handbook</a></li>
      <li><a href="/getting-started/feature-library/overview2/keyboard-shortcuts">Keyboard Shortcuts</a></li>
      <li><a href="/getting-started/feature-library/overview2/canned-responses">Canned Responses</a></li>
    </ul>
  </div>
