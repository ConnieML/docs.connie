...
This feature depends on a configured set of rules for the different Agent Activities. After enabling the feature the following configuration is required
