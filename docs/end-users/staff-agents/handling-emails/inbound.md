...
title: "Receiving and Replying to Emails"
sidebar_position: 2
---
...
2. You'll see the sender's name or email address, along with a preview of the subject line
3. An **email icon** tells you it's an email task
4. Click the **green checkmark** to accept the task
...
1. Type your response in the **reply field** below the email
2. Format your message as needed (some setups include basic formatting tools)
3. **Attach files** if needed using the attachment button
4. Click **"Send"**
...
1. Select a **Disposition** — a closing code like "Resolved," "Follow-up Required," or "Escalation"
2. Add any **notes** about the interaction
3. Click **"Complete"** to close the task
