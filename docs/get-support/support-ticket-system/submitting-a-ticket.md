---
sidebar_label: Submitting a Ticket
sidebar_position: 1
...
> 💡 **Tip:** one issue per ticket. If you have two unrelated problems, file two tickets so each can be tracked and resolved on its own.
...
You'll get an email confirmation, the Care Team will pick up your ticket, and they'll reply by email as they work it. To follow your ticket, see **[Checking & Managing Your Tickets](/get-support/support-ticket-system/checking-and-managing)**.
