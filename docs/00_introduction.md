...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginTop: '30px', marginBottom: '30px'}}>
    ...
    <div style={{borderTop: '1px solid #c8e6c9', paddingTop: '16px', marginTop: '16px'}}>
      <div style={{marginBottom: '12px'}}>
        <a href="/end-users/staff-agents" style={{
          ...
          <img src="/img/avatars/agent-avatar.png" style={{
            width: '32px',
            height: '32px',
            borderRadius: '50%',
            marginRight: '12px',
      ...
      <div style={{marginBottom: '12px'}}>
        <a href="/end-users/supervisors/overview" style={{
          ...
          <img src="/img/avatars/supervisor-avatar.png" style={{
            width: '32px',
            height: '32px',
            borderRadius: '50%',
            marginRight: '12px',
      ...
      <div>
        <a href="/end-users/administrators/getting-started" style={{
          ...
          <img src="/img/avatars/admin-avatar.png" style={{
            width: '32px',
            height: '32px',
            borderRadius: '50%',
            marginRight: '12px',
  ...
  <div style={{
    ...
    <div style={{borderTop: '1px solid #ce93d8', paddingTop: '16px', marginTop: '16px'}}>
      ...
      <a href="/ai-agents/api-reference" style={{
        display: 'block',
        padding: '10px 16px',
