...
**Implementation:** → [Sinch Fax Setup Guide](/techops/codebase/fax/sinch-implementation)
...
- **Sinch Users:** → [Continue to Sinch Setup Guide](/techops/codebase/fax/sinch-implementation)
