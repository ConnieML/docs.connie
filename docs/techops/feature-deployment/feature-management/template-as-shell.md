...
8. You can follow the instructions for [local development setup](/techops/feature-deployment/running-locally) and then [adding a feature](/techops/feature-deployment/feature-management/add-new-feature)
