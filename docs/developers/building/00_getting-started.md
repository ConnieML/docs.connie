...
1. If you have not already done an initial deployment of the template to your Connie account, first [install the template](/developers/install-template) on your account.
2. Then, follow the steps to [run the template locally](/developers/run-locally).
