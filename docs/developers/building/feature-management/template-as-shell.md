...
8. You can follow the instructions for [local development setup](/developers/run-locally) and then [adding a feature](/developers/building/feature-management/add-new-feature)
