...
**Setup guide:** → [Email Notifications Add-on](/developers/building/feature-management/channels/voice/add-ons/email-notifications)
...
**Setup guide:** → [Transcription Add-on](/developers/building/feature-management/channels/voice/add-ons/transcription)
...
For complete deployment instructions including troubleshooting and account setup, see the [Account-Specific Deployment Guide](/developers/building/deployment/account-specific-deployment).
:::
...
See [Why This Matters](/developers/building/deployment/account-specific-deployment#why-this-matters) for the incident that created this protocol.
:::
...
### Troubleshooting
- [Voice Troubleshooting](/developers/building/feature-management/channels/voice/troubleshooting/)
