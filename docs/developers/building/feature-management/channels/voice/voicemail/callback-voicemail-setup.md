...
Follow the detailed Mailgun setup in [Email Notifications Add-on](/developers/building/feature-management/channels/voice/add-ons/email-notifications):
...
See [Email Notifications troubleshooting](/developers/building/feature-management/channels/voice/add-ons/email-notifications#troubleshooting)
